# NOTE: This script uses the here package. If you haven't
# already, you should create a directory with the IV_checklist.Rproj
# file. In that directory, you should create two folders: /code
# and /data. Put the scripts in /code and put the IPUMS extract
# in /data. This script will create cg2006.rds and save it in /data.
# iv_checklist.R will replicate the main analysis in Conley
# and Glauber (2006) and implement the checklist items.
...
census <- read_csv(here("data", "census.csv"))
...
saveRDS(households, here("data", "cg2006.rds"))
